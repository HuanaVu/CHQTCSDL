package RTDRestaurant.Controller.Service.Customer;
...
public class ServiceCustomer {
    ...
    //Kiểm tra điểm đủ, trừ điểm và giảm số lượng Voucher
    public void exchangeVoucherDirect(int ID_KH, String Code_Voucher) throws SQLException {
        String sql = "BEGIN exchangeVoucherDirect(?, ?); END;";
        CallableStatement cs = con.prepareCall(sql);
        cs.setInt(1, ID_KH);
        cs.setString(2, Code_Voucher);
        cs.execute();
        cs.close();
    }}
