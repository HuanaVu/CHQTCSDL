...
public class MS_ConfirmExchangeVoucher extends javax.swing.JDialog {
    ...
    private ModelHoaDon selectedBill;
    private ModelVoucher selectedVoucher;
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOKActionPerformed
        if (selectedBill != null && selectedVoucher != null) {
            try {
                service.exchangeVoucher(selectedBill.getIdHoaDon(), selectedVoucher.getCode());
